				...
				<div class="contact-section contact-social">
					...
					<ul class="social-list">
						<li>
							...
							<span>GitHub <span>N-Molham</span></span>
							</a>
						</li>
						<li>
							<a href="http://plus.google.com/+NabeelMolham" class="social-googleplus" target="_blank">
								<svg viewBox="0 0 100 100" class="shape-googleplus">
									<use xlink:href="#googleplus-1"></use>
								</svg>
								<svg viewBox="0 0 100 100" class="shape-googleplus">
									<use xlink:href="#googleplus-2"></use>
								</svg>
								<svg viewBox="0 0 100 100" class="shape-googleplus">
									<use xlink:href="#googleplus-3"></use>
								</svg>
								<span>Google+ <span>NabeelMolham</span></span>
							</a>
						</li>
						<li>
							<a href="http://twitter.com/NabeelMolham" class="social-twitter" target="_blank">
								<svg viewBox="0 0 100 100" class="shape-twitter">
									<use xlink:href="#shape-twitter"></use>
								</svg>
								<span>Twitter <span>@NabeelMolham</span></span>
							</a>
						</li>
						<li>
							<a href="http://facebook.com/nabeel.molham" class="social-facebook" target="_blank">
								<svg viewBox="0 0 100 100" class="shape-facebook">
									<use xlink:href="#shape-facebook"></use>
								</svg>
								<span>Facebook <span>nabeel.molham</span></span>
							</a>
						</li>
						<li>
							<a href="http://www.youtube.com/user/nabeelmolham" class="social-youtube" target="_blank">
							<svg viewBox="0 0 100 100" class="shape-youtube">
								<use xlink:href="#shape-youtube"></use>
							</svg>
							<span>YouTube <span>nabeelmolham</span></span>
							</a>
						</li>
					</ul><!-- .social -->
				</div><!-- .contact-social -->
